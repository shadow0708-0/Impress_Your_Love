const config = {
  ...
  */
  ...
  incorrectPasscodeMessage: "Incorrect passcode, hint: our birthdates date!", // Message shown for incorrect passcode
  ...
  trendingSearches: [
    ...
    "Rit's favouratie things", // A personalized trending search
  ],
